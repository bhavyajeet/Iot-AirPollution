...
// WIFI params
char* WIFI_SSID = "Tsp";    // Configure here the SSID of your WiFi Network
char* WIFI_PSWD = "pwkn885881";
// "62y978{V"; // Configure here the PassWord of your WiFi Network
...
// oneM2M : CSE params
String CSE_IP      = "192.168.43.9"; //Configure here the IP Address of your oneM2M CSE
...
//MISC
int LUM_PIN = 90;  // Adapt it accordding to your wiring
int LED_PIN = D0;  // Adapt it accordding to your wiring. Use D0 for onboarded led
#define ON_STATE  LOW // *** External LED is active at HIGH, while Onboarded LED is active at LOW. 
#define OFF_STATE HIGH  // *** Adapat it is according to your config
...
// Global variables
           // time object used for achiebing pseudo-parallelism by the µController
...
void init_led() {
  String initialDescription = "Name = node_a_humdifier\t"
                              "Location = Home\t";
  String initialData = "switchOff";
  registerModule("node_a_humdifier", true, initialDescription, initialData);
}
void task_led() {
...
void command_led(String cmd) {
  if (cmd == "switchOn") {
#ifdef DEBUG
    Serial.println("Switching on the humid ...");
#endif
...
#ifdef DEBUG
    Serial.println("Switching off the hum ...");
#endif
    digitalWrite(LED_PIN, OFF_STATE);
    digitalWrite(HUM_PIN, LOW);
